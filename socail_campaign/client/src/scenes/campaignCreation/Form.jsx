...
const registerSchema = yup.object().shape({
  ...
  goalAmount: yup.number().required("required"),
...
const Form = () => {
  ...
  const register = async (values, onSubmitProps) => {
    ...
    const savedUserResponse = await fetch(
      "http://localhost:3001/campaign/createCampaign",
      {
        method: "POST",
        body: formData,
      }
            ...
            { (
              <>
                ...
                <TextField
                  ...
                  name="campaignTitle"
                  error={
                    Boolean(touched.campaignTitle) && Boolean(errors.campaignTitle)
                  }
                ...
                <TextField
                  ...
                  value={values.story}
                  name="story"
                  error={Boolean(touched.story) && Boolean(errors.story)}
                ...
                <TextField
                  ...
                  name="goalAmount"
                  error={Boolean(touched.goalAmount) && Boolean(errors.goalAmount)}
